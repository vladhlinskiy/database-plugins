 ...
 * Test util methods.
 */
public final class DatabasePluginTestUtil {
  ...
  private DatabasePluginTestUtil() {
  ...
  /**
   * Reuses {@link Assert#assertEquals(double, double, double)} with default {@link DatabasePluginTestUtil#DELTA}.
