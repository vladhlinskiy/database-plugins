...
public class ETLDBOutputFormat<K extends DBWritable, V> extends DBOutputFormat<K, V> {
  ...
  private Connection getConnection(Configuration conf) {
    ...
    try {
      ...
      DBFormatConfig outputFormatConfig = new DBFormatConfig(conf);
      Map<String, String> connectionArgs = outputFormatConfig.getConnectionArguments();
      Properties properties = new Properties();
      properties.putAll(connectionArgs);
      connection = DriverManager.getConnection(url, properties);

      boolean autoCommitEnabled = outputFormatConfig.isAutoCommitEnabled();
      ...
      String level = outputFormatConfig.getTransactionIsolationLevel();
      ...
      for (String query : outputFormatConfig.getInitQueries()) {
